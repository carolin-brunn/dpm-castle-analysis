...
g = sns.relplot(data = delta_df, x = "PID diversity", y = "tuple_count", hue = "k", style = "k", 
                col_wrap = 3, palette = "colorblind", col = "delta", aspect = 2)
...
ax_label.set_ylabel("Cluster size")
g.set(xlabel = "PID diversity")
#plt.show()
plt.savefig(("./plots/PIDDiv_ClSize.pdf"), bbox_inches = "tight")
plt.close() 
